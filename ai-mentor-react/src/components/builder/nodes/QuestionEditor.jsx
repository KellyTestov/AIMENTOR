    ...
    <div className="cv">
      ...
      <div className="field-block">
        ...
        <p className="crit-section-desc">
          ...
          Сумма баллов по всем критериям формирует максимальный балл за вопрос.
        </p>
        <p className="qe-compl-hint">
          💡 Порог прохождения единицы обучения настраивается в блоке «Завершение»
        </p>
