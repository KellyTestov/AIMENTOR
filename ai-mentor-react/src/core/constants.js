...
export const PERMISSION_MATRIX = [
  ...
  { id: 'create_cc_template',  label: 'Создавать шаблоны карточки клиента',               perLevel: [false, false, false, false, true,  true,  true ] },
  { id: 'access_monitoring',   label: 'Доступ к мониторингу бизнес-линии',                perLevel: [false, false, false, false, true,  true,  true ] },
  { id: 'review_requests',     label: 'Рассматривать заявку на получение доступа',        perLevel: [false, false, false, false, false, true,  true ] },
  { id: 'view_audit_logs',     label: 'Просмотр логов действий в бизнес-линии',           perLevel: [false, false, false, false, false, true,  true ] },
...
export function levelToRights(level) {
  ...
  return {
    ...
    isAdmin:              l >= 4,
    canCreateCcTemplate:  l >= 4,
    canAccessMonitoring:  l >= 4,
    canReviewRequests:    l >= 5,
    canViewAuditLogs:     l >= 5,
    canManageUsers:       l >= 5,
